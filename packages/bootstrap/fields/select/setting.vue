  ...
  <field-setting :field="field">
    <section class="xform-bs-field-setting-prop">
      ...
      >
        ...
        <button type="button" class="btn btn-link btn-text text-danger" @click="removeOption(option)" :disabled="field.options.length <= 1">删除</button>
      </div>
      <button type="button" class="btn btn-link btn-text btn-sm p-0" @click="addOption">添加选项</button>
    </section>
...
import { useOptions, useDefaultValueApi } from '@bootstrap/util'
