<template>
  <field-setting :field="field" :placeholder="false">
    ...
    <section class="xform-el-field-setting-prop">
      ...
      >
        <el-input v-model="option.value" size="small" placeholder="请输入选项内容"/>
        <el-button 
      ...
      <el-button type="primary" size="small" @click="addOption" plain>添加选项</el-button>
    </section>

    <section class="xform-el-field-setting-prop">
      <header>默认值：</header>
      <div :class="classes.defaultValue">
        <el-select v-model="compatType" size="small" :class="classes.compatType">
          <el-option 
...
import { useOptions, useDefaultValueApi, useFieldProp } from '../util'
